        ...
        foreach ($this->slice as $key => $value) {
            if (is_array($value)) {
                foreach ($value as $k => $v) {
                    if (isset($this->CI->slices) && method_exists($this->CI->slices, $v)) {
            ...
            elseif (!is_numeric($key)) {
                if (isset($this->CI->slices) && method_exists($this->CI->slices, $key)) {
                ...
                if (isset($this->CI->slices) && method_exists($this->CI->slices, $value)) {
